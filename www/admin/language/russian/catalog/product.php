...
$_['text_provider_subject']		= 'Ваш товар переведён в статус "включёно"';
$_['text_provider_message']		= '
Здравствуйте!
<br /><br />
Ваш товар <b>%s</b> был включён администратором магазина <b><a href="%s" target="_blank" style="text-decoration:none;"><font color="#000000">Open</font><font color="#FF0000">Cart</font><font color="#000000">.ru</font></a></b>
';
...
$_['entry_filter']           = 'Фильтры:<br /><span class="help">(Автокомплит)</span>';
